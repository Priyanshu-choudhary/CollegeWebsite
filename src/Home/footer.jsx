          ...
          <div className="mb-6">
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">Meerut College for Girls Education, Chitwana Sherpur, near Kila Parkshitgarh, Kila-Asifabad road, Meerut, Uttar Pradesh - 250001</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:rahul.tyagidr@gmail.com" className="text-gray-300 hover:text-white transition">rahul.tyagidr@gmail.com</a>
              </li>
              <li className="flex items-center">
