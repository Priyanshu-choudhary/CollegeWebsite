    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* Announcements */}
          <div className="md:col-span-2 bg-orange-50 rounded-xl p-6 shadow-sm">
            <div className="flex items-center mb-6">
              <FaRegBell className="text-orange-500 text-2xl mr-3" />
              ...
              {announcements.map((item) => (
                <div key={item.id} className="bg-white p-4 rounded-lg shadow-xs hover:shadow-md transition">
                  <div className="flex justify-between items-start mb-2">
                    <span className="bg-orange-100 text-orange-500 text-xs font-medium px-2.5 py-0.5 rounded">
                      {item.category}
                    </span>
                  ...
                  <a 
                    href={item.link} 
                    className="text-orange-500 font-medium inline-flex items-center text-sm hover:underline"
                  >
                    Read More
          ...
          <div className="bg-gray-50 rounded-xl p-6 shadow-sm">
            <div className="flex items-center mb-6">
              <FaNewspaper className="text-orange-500 text-2xl mr-3" />
            ...
            <div className="space-y-5">
              {latestNews.map((item) => (
                <div key={item.id} className="pb-4 border-b border-gray-200 last:border-0 last:pb-0">
                  ...
                  <h4 className="text-lg font-semibold text-gray-800 mb-2 hover:text-orange-500 transition">
            ...
            {/* Ticker (Indian Style) */}
            <div className="mt-8 bg-white p-4 rounded-lg shadow-xs border-l-4 border-orange-400">
              ...
              <div className="text-sm text-gray-600">
                ...
                {/* <a href="/notice/summer-vacation" className="text-orange-500 font-medium inline-flex items-center text-xs mt-2 hover:underline">
                  View Notice
        ...
        <div className="text-center mt-10">
          <a 
            href="/news" 
            className="inline-flex items-center bg-orange-500 hover:bg-orange-500 text-white px-6 py-3 rounded-lg font-medium transition"
          >
