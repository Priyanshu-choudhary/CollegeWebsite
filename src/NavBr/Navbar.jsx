            ...
            <div className="flex space-x-8">
              ...
              <div className="relative group">
                <button
                  ...
                  className="flex items-center text-gray-800 hover:text-indigo-700 font-medium py-2 px-3 rounded-md hover:bg-indigo-50 transition-colors duration-200"
                ...
                >
                  <div className="py-1">
                    <a
                      href="/courses"
                      className="block px-4 py-3 text-gray-700 hover:bg-indigo-50 hover:text-indigo-700 transition-colors flex items-center"
                    ...
                    <a
                      ...
                      onClick={() => setIsCoursesOpen(false)}
                    >
                      <MdOutlineLibraryBooks className="mr-2 text-indigo-600 text-lg" />
                      <div>
                  ...
                  <div className="border-t border-gray-100 px-4 py-2 bg-gray-50 rounded-b-lg">
                    <a
                      href="/courses"
                      className="text-sm text-indigo-700 hover:text-indigo-800 font-medium inline-flex items-center"
                      onClick={() => setIsCoursesOpen(false)}
                    >
                      View all courses
